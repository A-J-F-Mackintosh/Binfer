...
def rescale_min_s(arg_list):
	...
	max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s, r_distance_array, r_array, exon_array, F, alpha, Ne, window_size = arg_list
...
def optimisation_3N_classicBGS_mp(params, grad, mu, observed_SFS_windows, verbose, 
	r_distance_array, exon_array, r_array, mode, ploidy, genomes, observed_Ne, maximize, precision, alpha, 
	mask_hf, eps, processes, time_test, window_size):
	...
	arg_list_list.append([max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s_0, r_distance_array, r_array, exon_array, F, 0, Ne0, window_size])
	arg_list_list.append([max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s_1, r_distance_array, r_array, exon_array, F, 0, Ne1, window_size])
	arg_list_list.append([max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s_2, r_distance_array, r_array, exon_array, F, 0, Ne2, window_size])
