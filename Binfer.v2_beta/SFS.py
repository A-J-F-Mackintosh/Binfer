...
def moments_seven_epoch(params, ns, pop_ids=None):
	"""
	Six epoch model of constant pop size
	"""
	nu0, nu1, nu2, nu3, nu4, nu5, T0, T1, T2, T3, T4, T5 = params
	sts = moments.LinearSystem_1D.steady_state_1D(ns[0])
	fs = moments.Spectrum(sts, pop_ids=pop_ids)
	fs.integrate([nu0], T0, 0.02)
	fs.integrate([nu1], T1, 0.02)
...
def get_2N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
	B_p_1, B_p_2, B_p_3, B_p_4, step, N0, N1, B0, B1, mu, genomes):
	...
	if ND_step_4 < step:
		sfs = moments_six_epoch((
			(N0*B0) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_4))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_3))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_2))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_1))) / (N1*B1), 
			(step - ND_step_4) / (B1*N1*2), 
			(ND_step_4 - ND_step_3) / (B1*N1*2), 
			(ND_step_3 - ND_step_2)/ (B1*N1*2), 
			(ND_step_2 - ND_step_1) / (B1*N1*2), 
			ND_step_1 / (B1*N1*2)
			), 
		[genomes], pop_ids=None) * theta

	elif ND_step_3 < step < ND_step_4:
		sfs = moments_six_epoch((
			(N1*(1-((1-B1)*B_p_4))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_4))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_3))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_2))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_1))) / (N1*B1), 
			(ND_step_4 - step) / (B1*N1*2), 
			(step - ND_step_3) / (B1*N1*2), 
			(ND_step_3 - ND_step_2)/ (B1*N1*2), 
			(ND_step_2 - ND_step_1) / (B1*N1*2), 
			ND_step_1 / (B1*N1*2)
			), 
	...
	elif ND_step_2 < step < ND_step_3:
		sfs = moments_six_epoch((
			(N1*(1-((1-B1)*B_p_4))) / (N1*B1), 
			(N1*(1-((1-B1)*B_p_3))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_3))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_2))) / (N1*B1), 
			(N0*(1-((1-B0)*B_p_1))) / (N1*B1), 
			(ND_step_4 - ND_step_3) / (B1*N1*2), 
			(ND_step_3 - step) / (B1*N1*2), 
			(step - ND_step_2)/ (B1*N1*2), 
			(ND_step_2 - ND_step_1) / (B1*N1*2), 
			ND_step_1 / (B1*N1*2)
			), 
		[genomes], pop_ids=None) * theta
...
def get_3N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
	B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, N0, N1, N2, B0, B1, B2, mu, genomes):

	theta = mu * N2 * B2 * 4

	if ND_step_4 < step0:
		sfs = moments_seven_epoch((
			(N1*B1) / (N2*B2),
			(N0*B0) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_4))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_2))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_1))) / (N2*B2), 
			(step1 - step0) / (B2*N2*2), 
			(step0 - ND_step_4) / (B2*N2*2), 
			(ND_step_4 - ND_step_3) / (B2*N2*2), 
			(ND_step_3 - ND_step_2)/ (B2*N2*2), 
			(ND_step_2 - ND_step_1) / (B2*N2*2), 
			ND_step_1 / (B2*N2*2)
			), 
		[genomes], pop_ids=None) * theta

	elif ND_step_3 < step0 < ND_step_4 < step1:
		sfs = moments_seven_epoch((
			(N1*B1) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_4))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_4))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_2))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_1))) / (N2*B2), 
			(step1 - ND_step_4) / (B2*N2*2), 
			(ND_step_4 - step0) / (B2*N2*2), 
			(step0 - ND_step_3) / (B2*N2*2), 
			(ND_step_3 - ND_step_2)/ (B2*N2*2), 
			(ND_step_2 - ND_step_1) / (B2*N2*2), 
			ND_step_1 / (B2*N2*2)
			), 
	...
	elif ND_step_2 < step0 < ND_step_3 < ND_step_4 < step1:
		sfs = moments_seven_epoch((
			(N1*B1) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_4))) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_2))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_1))) / (N2*B2), 
			(step1 - ND_step_4) / (B2*N2*2), 
			(ND_step_4 - ND_step_3) / (B2*N2*2), 
			(ND_step_3 - step0) / (B2*N2*2), 
			(step0 - ND_step_2)/ (B2*N2*2), 
			(ND_step_2 - ND_step_1) / (B2*N2*2), 
			ND_step_1 / (B2*N2*2)
			), 
		[genomes], pop_ids=None) * theta

	elif ND_step_3 < step0 < step1 < ND_step_4:
		sfs = moments_seven_epoch((
			(N2*(1-((1-B2)*B_p_4))) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_4))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_4))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_2))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_1))) / (N2*B2), 
			(ND_step_4 - step1) / (B2*N2*2), 
			(step1 - step0) / (B2*N2*2), 
			(step0 - ND_step_3) / (B2*N2*2), 
			(ND_step_3 - ND_step_2)/ (B2*N2*2), 
			(ND_step_2 - ND_step_1) / (B2*N2*2), 
	...
	elif step0 < ND_step_3 < step1 < ND_step_4:
		sfs = moments_seven_epoch((
			(N2*(1-((1-B2)*B_p_4))) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_4))) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_3))) / (N2*B2), 
	...
	elif ND_step_2 < step0 < step1 < ND_step_3:
		sfs = moments_seven_epoch((
			(N2*(1-((1-B2)*B_p_4))) / (N2*B2), 
			(N2*(1-((1-B2)*B_p_3))) / (N2*B2), 
			(N1*(1-((1-B1)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_3))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_2))) / (N2*B2), 
			(N0*(1-((1-B0)*B_p_1))) / (N2*B2), 
			(ND_step_4 - ND_step_3) / (B2*N2*2), 
			(ND_step_3 - step1) / (B2*N2*2), 
			(step1 - step0) / (B2*N2*2), 
			(step0 - ND_step_2)/ (B2*N2*2), 
			(ND_step_2 - ND_step_1) / (B2*N2*2), 
			ND_step_1 / (B2*N2*2)
