...
def optimisation_1N_classicBGS(params, grad, mu, observed_SFS_windows, verbose, 
	...
	if alpha:
		...
		if Ne0 is None:
			mean_B = np.sum(np.multiply(B_array, np.sum(observed_SFS_windows, axis=1))) / np.sum(observed_SFS_windows) # find Ne0 analytically
			if mean_B == 0:
				return float("-inf")
			Ne0 = observed_Ne / mean_B
	...
	print(params, Ne0, loglikelihood, np.min(B_array), np.max(B_array), flush=True)
...
def optimisation_2N_classicBGS(params, grad, mu, observed_SFS_windows, verbose, 
	...
	overall_Nmax = overall_Ne_recursion(0, 0, 0, [Ne0, step, Ne1, float("inf")], 0)
	...
	if B_array_0 is None or B_array_1 is None:
		if maximize:
			return float("-inf")
		else:
			return float("inf")
	...
	try:
		ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4 = BinfB.get_ND_four_step(s_shape, s_mean*(h*(1 - F) + F), min_s_0, 4)
	except:
		if maximize:
			return float("-inf")
		else:
	...
	if ND_step_1 is None:
		if maximize:
			return float("-inf")
		else:
			return float("inf")

	#print(ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4)
	...
	for idx, window_SFS in enumerate(observed_SFS_windows):
		...
		if np.sum(window_SFS) == 0:
			...
			if precision == 0:
				...
				SFS_key = tuple([round(B_array_0[idx], 2), round(B_array_1[idx], 2)])

				if SFS_key not in SFS_lookup_BGS.keys():
					try:
						if alpha == None:
							
							SFS_lookup_BGS[SFS_key] = BinfS.get_2N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
								B_p_1, B_p_2, B_p_3, B_p_4, step, Ne0, Ne1, 
								round(B_array_0[idx], 2), round(B_array_1[idx], 2), mu, genomes)
				...
				SFS_key = tuple([round(B_array_0[idx], 3), round(B_array_1[idx], 3)])
				...
				if SFS_key not in SFS_lookup_BGS.keys():
					try:
						if alpha == None:
							SFS_lookup_BGS[SFS_key] = BinfS.get_2N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
								B_p_1, B_p_2, B_p_3, B_p_4, step, Ne0, Ne1, 
								round(B_array_0[idx], 3), round(B_array_1[idx], 3), mu, genomes)
						else:
							SFS_lookup_BGS[SFS_key] = BinfS.get_2N_SFS_selfing_ND(ND_step_1, ND_step_2, step, Ne0, Ne1, 
				...
				try:
					if alpha == None:
						SFS_lookup_BGS[SFS_key] = BinfS.get_2N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
								B_p_1, B_p_2, B_p_3, B_p_4, step, Ne0, Ne1, 
								B_array_0[idx], B_array_1[idx], mu, genomes)
					else:
		...
		if np.sum(window_SFS) == 0:
			...
			if precision == 0:
				...
				if SFS_key not in SFS_lookup_BGS.keys():
					try:
						if alpha == None:
							SFS_lookup_BGS[SFS_key] = BinfS.get_3N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
								B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, Ne0, Ne1, Ne2, 
								round(B_array_0[idx], 2), round(B_array_1[idx], 2), round(B_array_2[idx], 2), mu, genomes)
						else:
							SFS_lookup_BGS[SFS_key] = BinfS.get_2N_SFS_selfing_ND(ND_step_1, ND_step_2, step, Ne0, Ne1, 
								round(B_array_0[idx], 2), round(B_array_1[idx], 2), alpha, mu, genomes)
				...
				if SFS_key not in SFS_lookup_BGS.keys():
					try:
						if alpha == None:
							SFS_lookup_BGS[SFS_key] = BinfS.get_3N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
								B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, Ne0, Ne1, Ne2, 
								round(B_array_0[idx], 3), round(B_array_1[idx], 3), round(B_array_2[idx], 3), mu, genomes)
						else:
							SFS_lookup_BGS[SFS_key] = BinfS.get_2N_SFS_selfing_ND(ND_step_1, ND_step_2, step, Ne0, Ne1, 
								round(B_array_0[idx], 3), round(B_array_1[idx], 3), alpha, mu, genomes)
				...
				try:
					if alpha == None:
						expected_SFS = BinfS.get_3N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
								B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, Ne0, Ne1, Ne2, 
								B_array_0[idx], B_array_1[idx], B_array_2[idx], mu, genomes)
					else:
						expected_SFS = BinfS.get_2N_SFS_selfing_ND(ND_step_1, ND_step_2, step, Ne0, Ne1, 
							B_array_0[idx], B_array_1[idx], alpha, mu, genomes)
...
def do_calc(sfs_chunk):
	...
	for sfs_c in sfs_chunk:
		sfs_dict = {}
		ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, Ne0, Ne1, Ne2, B0, B1, B2, mu, genomes, idx = sfs_c
		try:
			sfs_dict["sfs"] = BinfS.get_3N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, 
				B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, Ne0, Ne1, Ne2, B0, B1, B2, mu, genomes)
		except:
			sfs_dict["sfs"] = None
...
def do_calc_careful(sfs_chunk):
	results_chunk = []
	for sfs_c in sfs_chunk:
		sfs_dict = {}
		ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4, step, Ne0, Ne1, B0, B1, mu, genomes, idx = sfs_c
		try:
			sfs_dict["sfs"] = BinfS.get_2N_SFS_careful_ND(ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4, step, Ne0, Ne1, B0, B1, mu, genomes)
		except:
			sfs_dict["sfs"] = None
		if (sfs_dict["sfs"] <= 0).sum() > 0 or (sfs_dict["sfs"] >= 1).sum() > 0 or np.isnan(np.sum(sfs_dict["sfs"])):
			sfs_dict["sfs"] = None
...
def rescale_min_s(arg_list):
	...
	max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s, r_distance_array, r_array, exon_array, F, Ne, window_size = arg_list
...
def optimisation_3N_classicBGS_mp(params, grad, mu, observed_SFS_windows, verbose, 
	...
	arg_list_list.append([max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s_0, r_distance_array, r_array, exon_array, F, Ne0, window_size])
	arg_list_list.append([max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s_1, r_distance_array, r_array, exon_array, F, Ne1, window_size])
	arg_list_list.append([max_thresh_diff, max_rs_iters, s_shape, s_mean, u, alpha, h, min_s_2, r_distance_array, r_array, exon_array, F, Ne2, window_size])
	...
	if B_array_0 is None or B_array_1 is None or B_array_2 is None:
		print(params, "B-map failed", flush=True)
		if maximize:
			return float("-inf")
		else:
			return float("inf")
	...
	for idx, window_SFS in enumerate(observed_SFS_windows):
		...
		if np.sum(window_SFS) == 0:
			...
			sfs_params.append([ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4, step0, step1, Ne0, Ne1, Ne2, B_array_0[idx], B_array_1[idx], B_array_2[idx], mu, genomes, idx])

	results = []
	predicted_SFS_array = np.zeros(observed_SFS_windows.shape)
	predicted_Bmap_array = np.zeros(len(observed_SFS_windows))
	...
	for result in results:
		if result["sfs"] is None:
			print(params, "sfs calculation failed", flush=True)
			if maximize:
				return float("-inf")
			else:
				return float("inf")
			...
			if return_B_map:
				predicted_SFS_array[result["idx"]][0:genomes] = expected_SFS[0:genomes]
	...
	if return_B_map:
		return predicted_SFS_array, predicted_Bmap_array
...
def optimisation_2N_classicBGS_mp(params, grad, mu, observed_SFS_windows, verbose, 
	...
	results = []
	with poolcontext(processes=min(processes, 2)) as pool:
		if time_test:
			t0 = time.time()
		for result in pool.imap_unordered(rescale_min_s, arg_list_list, 1):
			results += result
	...
	B_array_0, min_s_0, B_array_1, min_s_1 = results
	...
	for idx, window_SFS in enumerate(observed_SFS_windows):
		...
		if np.sum(window_SFS) == 0:
			...
			sfs_params.append([ND_step_1, ND_step_2, ND_step_3, ND_step_4, B_p_1, B_p_2, B_p_3, B_p_4, step, Ne0, Ne1, B_array_0[idx], B_array_1[idx], mu, genomes, idx])
	...
	with poolcontext(processes=processes) as pool:
		if time_test:
			t0 = time.time()
		for result in pool.imap_unordered(do_calc_careful, sfs_params_chunked, 1):
			results += result
			if time_test:
				t1 = time.time()
				print(t1 - t0)
...
def optimise_Ne0_1N_selfing(params, grad, ND_step_1, ND_step_2, mu, diploids, alpha, observed_SFS_windows, B_array_0, genomes):
...
def optimisation_1N_classicBGS_selfing(params, grad, mu, observed_SFS_windows, verbose, 
	...
	if mode == "SFS":
		...
		# probably have to do this numerically...

		if Ne0 is None:

			local_nlopt_function = partial(optimise_Ne0_1N_selfing, ND_step_1 = ND_step_1, ND_step_2 = ND_step_2, 
				mu = mu, diploids = diploids, alpha = alpha, observed_SFS_windows = observed_SFS_windows, B_array_0 = B_array_0, 
				genomes = genomes)

			opt = nlopt.opt(nlopt.LN_NELDERMEAD, 1)
			opt.set_maxeval(300)
			opt.set_upper_bounds([observed_Ne*1e6])
			opt.set_lower_bounds([observed_Ne])
			opt.set_max_objective(local_nlopt_function)
			xopt = opt.optimize([observed_Ne*2])
			Ne0 = xopt[0]
	...
	print(params, Ne0, loglikelihood, flush=True)
	if maximize:
		return loglikelihood
	else:
		return -1 * loglikelihood
